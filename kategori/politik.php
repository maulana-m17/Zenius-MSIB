...
<?php 
    ...
    $sql = mysqli_query($koneksi, "SELECT * FROM berita JOIN kategori ON berita.kategori_id = kategori.id WHERE kategori_id = 2");
    $tampil = mysqli_query($koneksi, "SELECT * FROM berita WHERE id = 9");
?>
        ...
        <div class="col mb-5">
            <nav class="navbar navbar-expand-lg" style="background-color: #7e121f34;">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"style="font-size: 24px; padding-left: 62px;" aria-current="page" href="#">Politik</a>
                    </li>
                    <li class="nav-item">
...
<div class="container">
    <div class="row">
    <h1 class="fw-bold" style="color: #A72535;">Politik<br><br></h1>
