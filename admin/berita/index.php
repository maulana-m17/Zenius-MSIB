    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 yp-4">
                ...
                <h1>Daftar Berita</h1>
                <p>Selamat Datang di Halaman Daftar Berita Sky News</p>

                <div class="card">
                    <div class="card-body">
                        <a href="../berita/tambah.php" class="btn btn-block btn-warning mb-4" style="color: white;">
                        Upload Berita</a>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php while($datas = mysqli_fetch_assoc($sql) ) : ?>
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td><img src="../../img/<?= $datas["gambar"]; ?>" width="200"></td>
                                            <td><?= $datas["judul"]; ?></td>
                                            <td><?= $datas["desk_awal"]; ?></td>
                                            <td>
                                                <a href="show.php?id='.$data['id'].'" 
                                                class="btn btn-sm btn-warning" 
                                                style="color: white;">Lihat</a><br><br>

                                                <a href="edit.php?id='.$data['id'].'" 
                                                class="btn btn-sm btn-warning" 
                                                style="color: white;">Ubah</a><br><br>

                                                <a onclick="return confirm(`Apakah anda yakin?`)" 
                                                href="delete.php?id='.$data['id'].'" 
                                                class="btn btn-sm btn-danger" 
                                                style="color: white;">Hapus</a><br><br>
                                            </td>                                                  
                                        </tr>
                                    <?php $i++; ?>
                                    <?php endwhile; ?>
